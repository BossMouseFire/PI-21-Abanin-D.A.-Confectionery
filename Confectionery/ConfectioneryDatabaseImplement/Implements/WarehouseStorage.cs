...
namespace ConfectioneryDatabaseImplement.Implements
{
    public class WarehouseStorage : IWarehouseStorage
    {
        ...
        private static Warehouse CreateModel(WarehouseBindingModel model, Warehouse warehouse, ConfectioneryDatabase context)
        {
            ...
            if (model.Id.HasValue)
            {
                ...
                context.WarehouseComponents
                    .RemoveRange(warehouseComponents
                    .Where(rec => !model.WarehouseComponents
                    .ContainsKey(rec.ComponentId)).ToList());
                context.SaveChanges();
